...
const Entity = ({ options, setter, part }: options) => {
    ...
    return <div className="row wrap">
        ...
        {
            entity?.types && <><Select value={part.substring(2, 4)} onChange={e => {
                ...
                {
                    entityType?.subTypes && <Select value={part.substring(4, 6)} onChange={e => setter(entity.code + entityType.code + e.target.value)}>
